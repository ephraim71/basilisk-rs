...
const FACET_ASTRONOMICAL_UNIT_M: f64 = 149_597_870_700.0;
const FACET_SOLAR_FLUX_AT_EARTH_WPM2: f64 = 1368.0;
...
impl FacetSolarRadiationPressure {
    ...
    pub fn compute_output(&self, state: &SpacecraftStateMsg) -> EffectorOutput {
        ...
        let srp_pressure = FACET_SOLAR_FLUX_AT_EARTH_WPM2 / SPEED_OF_LIGHT_MPS
            * (FACET_ASTRONOMICAL_UNIT_M / sun_distance_m).powi(2);
...
fn prv_to_dcm(prv: Vector3<f64>) -> Matrix3<f64> {
    let angle = prv.norm();
    if angle == 0.0 {
...
mod tests {
    ...
    use crate::messages::{
        EclipseMsg, HingedRigidBodyMsg, Output, SpacecraftStateMsg, SunEphemerisMsg,
    };

    use super::{
        ASTRONOMICAL_UNIT_M, FACET_ASTRONOMICAL_UNIT_M, FACET_SOLAR_FLUX_AT_EARTH_WPM2,
        FacetSolarRadiationPressure, FacetSolarRadiationPressureConfig, SOLAR_FLUX_AT_EARTH_WPM2,
        SPEED_OF_LIGHT_MPS, SolarRadiationPressure, SolarRadiationPressureConfig, prv_to_dcm,
    };
    ...
    fn faceted_srp_uses_projected_panel_area_like_basilisk() {
        ...
        let state = make_state(Vector3::new(FACET_ASTRONOMICAL_UNIT_M, 0.0, 0.0));
    ...
    fn faceted_srp_ignores_panels_facing_away_from_sun() {
        ...
        let out = srp.compute_output(&make_state(Vector3::new(
            FACET_ASTRONOMICAL_UNIT_M,
            0.0,
            0.0,
        )));
        assert_eq!(out.force_inertial_n, Vector3::zeros());
    ...
    fn faceted_srp_matches_basilisk_unit_test_angle_matrix() {
        const CASES: &[(f64, f64, [f64; 3], [f64; 3], [f64; 3], [f64; 3])] = &[
            (
                ...
                [
                    7.47989353500040436e+10,
                    5.15885995413138007e+05,
                    1.45522626190523832e-09,
                ],
                [
                    -2.02426521610768207e-09,
                    7.36103154607472756e-09,
                    1.30029389651201269e-09,
                ],
                [
                    8.07689421493787326e-05,
                    6.94922003790389547e-10,
                    8.84087712273876494e-11,
                ],
                [
                    -4.85809474172430342e-10,
                    1.76709678887626562e-09,
                    3.08993553013402924e-10,
                ],
            ),
            (
                -1.81514242207410276e-01,
                ...
                [
                    7.47989353500040436e+10,
                    5.15885995413136377e+05,
                    -4.18541185261527595e-09,
                ],
                [
                    -1.69527338436825773e-09,
                    6.92231034796033242e-10,
                    3.27249808248759240e-09,
                ],
                [
                    8.07688409535506347e-05,
                    5.88865724239834186e-10,
                    -2.50672827755971150e-10,
                ],
                [
                    -4.06307769102161628e-10,
                    1.66003736665319856e-10,
                    7.84602315775134753e-10,
                ],
            ),
            (
                -1.81514242207410276e-01,
                ...
                [
                    7.47989353500040436e+10,
                    5.15885995413133118e+05,
                    -1.09709359577007079e-09,
                ],
                [
                    -1.11959151591885651e-09,
                    2.94461895494971787e-09,
                    6.71754904645029702e-09,
                ],
                [
                    8.07684496757949012e-05,
                    4.04274616511184557e-10,
                    -6.48525693892832591e-11,
                ],
                [
                    -2.67935190627053501e-10,
                    7.07147392958166552e-10,
                    1.60761108503976440e-09,
                ],
            ),
            (
                -1.81514242207410276e-01,
                ...
                [
                    7.47989353500040436e+10,
                    5.15885995